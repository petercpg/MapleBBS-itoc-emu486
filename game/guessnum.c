  ...
  int fighting;	/* Thor.990317: 對戰模式 */
{
  ...
  for (;;)
  {
    ...
    move(b_lines - 1, 0);
    /* 我猜您的數字是 \033[1;37m%d%d%d%d\033[m */
    ...
    move(hisNum + 2, 0);
    if (fighting)		/* Thor.990317: 對戰模式 */
      /* 第 \033[1;37m%d\033[m 次, 您猜 \033[1;36m%d%d%d%d\033[m, 我說 \033[1;33m%dA%dB\033[m; 我猜 \033[1;33m%d%d%d%d\033[m, 您說 \033[1;36m%dA%dB\033[m */
      ...
      /* 第 \033[1;37m%d\033[m 次, 我猜 \033[1;33m%d%d%d%d\033[m, 您說 \033[1;36m%dA%dB\033[m */
