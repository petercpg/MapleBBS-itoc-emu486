/*-------------------------------------------------------*/
/* game/fantan.c        ( NTHU CS MapleBBS Ver 3.10 )    */
/*-------------------------------------------------------*/
/* target : 接龍遊戲					 */
/* create : 98/08/04					 */
/* update : 01/03/01					 */
  ...
  int card;
{
  ...
  /* ○ */
  /* ● */
  char kind[4][3] = {"\xA1\xB8", "\xA1\xB9", "\xA1\xB3", "\xA1\xB4"};			/* 花色 */
  /* Ａ */
  /* ２ */
  /* ３ */
  /* ４ */
  ...
  /* ６ */
  /* ７ */
  char num[13][3] = {"\xA2\xCF", "\xA2\xB1", "\xA2\xB2", "\xA2\xB3", "\xA2\xB4", "\xA2\xB5", "\xA2\xB6",	/* 點數 */
		     /* ８ */
		     /* ９ */
		     /* Ｔ */
		     /* Ｊ */
...
{
  move(b_lines - 1, 0);
  /*  (q)離開 (r)重玩 (←→↑↓)移動 (↑)翻轉 (Enter)堆疊 (Space)指定/移動/翻牌    \033[m */
