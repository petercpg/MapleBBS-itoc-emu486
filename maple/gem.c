/*-------------------------------------------------------*/
/* maple/gem.c          ( NTHU CS MapleBBS Ver 3.00 )    */
/*-------------------------------------------------------*/
/* target : 精華區閱讀、編選			     	 */
/* create : 95/03/29				     	 */
/* update : 97/02/02				     	 */
  ...
  XO *xo;
{
  ...
  /* 存放位置 A)加到最後 I/N)插入目前位置 E)附加檔案 Q)離開 [A]  */
