  ...
  DATA *data;
{
  ...
  i = 12 - (strlen(title) >> 1);
  /*  \033[1;33m○ ──────────→ \033[41m%%%ds%%s%%%ds\033[40m ←────────── ○\033[m\n\n */
  ...
  int year, month, day;
{
  ...
  /* %26s\033[1;33;45m [%02d/%02d/%02d] 年齡統計 \033[m\n\n */
  ...
  int year, month, day;
{
  ...
  /* %26s\033[1;33;45m [%02d/%02d/%02d] 星座統計 \033[m\n\n */
  ...
  int year, month, day;
{
  ...
  /* %26s\033[1;33;45m [%02d/%02d/%02d] 性別統計 \033[m\n\n */
  ...
  int year, month, day;
{
  ...
  /* %26s\033[1;33;45m [%02d/%02d/%02d] 本日壽星 \033[m\n\n */
  ...
  int year, month, day;
{
  ...
  /* %26s\033[1;33;45m [%02d/%02d/%02d] 本月壽星 \033[m\n\n */
  ...
  int year, month, day;		/* 今天是幾年幾月幾日 */
{
  ...
  if (acct->month == month)
  {
	...
	return;
      ...
      /* [%3d]  %-25s  上站次數: %-5d  文章篇數: %-5d  生: %02d/%02d\n */
