  ...
  char *brdname;
{
  ...
  if (start > HTML_TALL)
  {
    /*  align=center><a href=?%s&%d>上%d篇</a */
  ...
  if (start <= total)
  {
    /*  align=center><a href=?%s&%d>下%d篇</a */
  ...
  char *brdname, *xname;
{
  ...
  if (xname)
    /* ></td>\n  <td width=60%% align=center><a href=/gem?%s&%s>回到卷宗</a */
  ...
  else if (brdname)
  {
    ...
    /* ></td>\n  <td width=60% align=center><a href=/mbox>信箱列表</a */
  ...
  Agent *ap;
{
  ...
  /* <form method=post onsubmit=\"if(t.value.length==0 || c.value.length==0) {alert('標題、內容均不可為空白'); return false;} return true;\">\n */
  ...
  Agent *ap;
{
  ...
  /* <form method=post onsubmit=\"if(u.value.length==0 || t.value.length==0 || c.value.length==0) {alert('收信人、標題、內容均不可為空白'); return false;} return true;\">\n */
  ...
  Agent *ap;
{
  ...
  /* 若確定要刪除此篇文章，請再次點選以下連結；若要取消刪除，請按 [上一頁] */
  ...
  /* <a href=/delpost?%s&%s&%s>刪除 [%s] 板第 %s 篇文章</a><br>\n */
  ...
  Agent *ap;
{
  ...
  /* 若確定要刪除此篇信件，請再次點選以下連結；若要取消刪除，請按 [上一頁] */
  ...
  /* <a href=/delmail?%s&%s>刪除信箱第 %s 篇信件</a><br>\n */
